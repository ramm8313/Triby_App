...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    replace: {
      production: {
        ...
        overwrite: true,
        replacements:[
          { from: 'bower_components/ngCordova/dist/ng-cordova-mocks.js', to: 'bower_components/ngCordova/dist/ng-cordova.min.js' },
      ...
      development: {
        ...
        overwrite: true,
        replacements:[
          { from: 'bower_components/ngCordova/dist/ng-cordova.min.js', to: 'bower_components/ngCordova/dist/ng-cordova-mocks.js' },
  ...
  grunt.registerTask('init', [
    'replace:production', // avoiding ngCordovaMocks
    'clean',
  ...
  grunt.registerTask('init-development', [
    'replace:development', // including ngCordovaMocks
    'clean',
    'ngconstant:development',
    'wiredep',
    'concurrent:server',
