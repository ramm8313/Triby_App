...
MyApp.service('CountryCodeService', function () {
    ...
    var _getCountryName = function(code){
    ...
    CountryCodeService.getCountryName = _getCountryName;
    CountryCodeService.getCountryCode = _getCountryCode;
